...
if __name__ == "__main__":
    with open('README.md', 'w') as readme_file, open('RECENT.md', 'w') as recent_file, open('posts.json', 'w') as posts_file:
        readme_file.write("# 潮流周刊\n\n> 记录工程师 ghost 的不枯燥生活，欢迎订阅，也欢迎 [推荐](https://github.com/ghwzlh/weekly/discussions/22) 你的好东西，Fork 自用可见 [开发文档](https://github.com/tw93/weekly/blob/main/Deploy.md)，期待你玩得开心~\n\n")
        ...
        for index, name in enumerate(filenames):
            if name.endswith('.md'):
                ...
                url = f'https://weekly.ghwzlh.fun/posts/{old_title}'
